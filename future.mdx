...
<CodeSurfer
  ...
  steps={[
    ...
    { lines: [ 18 ], notes: "no `type: 'boolean'` , `type: 'string'`, `type: 'number'`" },
...
<CodeSurfer
  ...
  steps={[
    ...
    { lines: [ 11 ], notes: "initial set triggers an event" },
  ]}
/>
...
<CodeSurfer
  ...
  steps={[
    ...
    { lines: [ 5 ], notes: "types are strict by default" },
    { lines: [ 16 ], notes: "they can be set to values of that type" },
    { lines: [ 17, 18 ], notes: "setting to a value of another type will throw" },
    { lines: [ 6 ], notes: "the type shorthand also sets up a strict type" },
    { lines: [ 20 ], notes: "again, they can be set to values of that type" },
    { lines: [ 21, 22 ], notes: "again, setting to a value of another type will throw" },
    { lines: [ 7 ], notes: "the default shorthand also sets up a strict type" },
    { lines: [ 24, 25 ], notes: "again, setting to a value of another type will throw" },
    { range: [ 8, 10 ], notes: "the `can-type` package can be used if you don't want strict types" },
    { range: [ 27, 31 ], notes: "type.maybe lets the value be the type or null or undefined" },
    { range: [ 33, 36 ], notes: "type.convert will convert any value to the type" },
    { range: [ 38, 41 ], notes: "type.maybeConvert supports the can-define behavior" }
  ]}
/>
...
<CodeSurfer
  ...
  lang="javascript"
  steps={[
    { range: [ 5, 24 ], notes: "Normal StacheDefineElement" },
